        ...
        <div className="bg-gray-800/50 p-4 md:p-6 rounded-lg flex-1 flex flex-col justify-between">
            <div className="space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-2 md:gap-4">
                    <ImageUploader label="Childhood Photo" onImageUpload={(file) => handleImageUpload(file, 'childhood')} previewUrl={childhoodImage.base64} small />
                    <ImageUploader label="Current Photo" onImageUpload={(file) => handleImageUpload(file, 'current')} previewUrl={currentImage.base64} small />
                </div>
