...
const PhotoMagic: React.FC<PhotoMagicProps> = ({ onStartEditing, isEditing, onBack }) => {
    ...
    <div className="w-full max-w-xl mx-auto flex flex-col flex-1 animate-fade-in">
      ...
      <div className="bg-gray-800/50 p-4 md:p-6 rounded-lg flex-1 flex flex-col justify-between">
        <div className="space-y-4">
            <ImageUploader label="Upload Your Photo" onImageUpload={handleImageUpload} previewUrl={originalImage.base64} small />
            <div>
